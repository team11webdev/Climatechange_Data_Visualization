...
export default function AUTH() {
    ...
    switch(signupProcessState){
        case 'default':
            signupUIControls = <Button variant="primary" type="submit">Submit</Button>
            break;
        case 'processing':
                ...
                <Form onSubmit={handleSignupSubmit}>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicCheckbox">
                        <Form.Text>Already have an account? 
                            <Button variant="light" onClick={changeAuthMode}>Login</Button>
                        </Form.Text>
                    </Form.Group>
                ...
                <Form onSubmit={handleLoginSubmit}>
                    ...
                    <Form.Group className="mb-3" controlId="formBasicCheckbox">
                        <Form.Text>Don't have an account? 
                            <Button variant="light" onClick={changeAuthMode}>Signup</Button>
                        </Form.Text>
                    </Form.Group>
